...
class CLI
  ...
  def greeting
    ...
    system("say 'Hi #{@name}, welcome to London Property Listings! My name is Serious, I am your personal assistant and I am going to help you find your perfect new home!'")
    @current_user = User.create(name: @name)
  end

    def yes_no
      system("say 'Now I am going to ask you a few questions to help you find the right place'")
      puts ""
  ...
  def choose_area
    ...
    system("say '#{@area_choice} - great choice!'")
    puts ""
    puts ""
    puts ""
    puts "                 Here's some information about this neighborhood:"
    system("say 'Here is some information about this neighborhood' ")
    puts ""
    puts ""
    display_the_hood
  end
  ...
  def display_the_hood
    ...
    system("say 'It has #{hood_choice.public_schools} public schools.'")
    puts ""
  ...
  def bedrooms
    ...
    if @num_bed > 0 && @num_bed <= 10
      ...
      system("say 'please enter a number between 1 and 10'")
      spaces(20)
      bedrooms
    end
  end
  ...
  def bathrooms
    ...
    if @num_bath > 0 && @num_bath < 6
      puts "                 Great! You chose #{@num_bed} bedroom(s) and #{@num_bath} bathroom(s)."
  ...
  def budget_question
    ...
    system("say 'Now it is time for the REAL QUESTION' ")
    puts ""
  ...
  def budget
    ...
    spaces(30)
    if @user_budget > 1000
      puts "                 Your monthly budget is £#{@user_budget}."
      system("say 'Your monthly budget is £#{@user_budget}'")
      spaces(5)
      show_listings
      ...
      system("say 'I did not quite get that. Please enter your monthly budget using number keys.'")
      spaces(10)
      budget
    end
  end
  ...
  def show_listings
    ...
    if @user_listings.length == 0
      puts "                 Sorry! I did not find any listings matching your criteria. Let's try again!"
      system("say 'Sorry! I did not find any listings matching your criteria. Let us try again!'")
      spaces(3)
      yes_no
    else
      puts "                 Awesome! I have #{@user_listings.length} listing(s)for you:"
      system("say 'Awesome! I have #{@user_listings.length} listings for you:'")
      spaces(2)
  ...
  def view_intro_text
    puts "                 To arrange a viewing please ENTER the listing ID
                        and I will take care of it!"
    system("say 'To arrange a viewing please ENTER the listing ID and I will take care of it!'")
    puts ""
  ...
  def listing_input
    ...
    # otherwise, check and see if the listing existed or was nil
      ...
      puts "                 I could not find that listing! Please select a valid ID or input 'F'"
      system("say 'I could not find that listing. Please enter a listing ID or press F to finish.'")
      listing_input
    else
  ...
  def open_listings
    system("say 'OK #{@name} now I am going to open the listings for you in your browser.
      I am also going to look at your calendar and arrange the viewings,
      you do not need to worry about anything. I got this.'")
